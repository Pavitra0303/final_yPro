...
<html>
    ...
    <body>
        ...
        <div class="card card-cascade narrower" style="padding-top:90px;background-color:#cc99ff;">
            ...
            <p style="text-align:right; padding-right: 30px;"><a href="information.jsp"><button type="button" class="delete"><i class="fas fa-plus-square">&nbsp;Add Transport Information</i></button></a>

            <p style="text-align:right; padding-right: 30px;"><a href="loginOut.jsp">Logout</a>

            <div><h1 style="text-align:center;">View Transportation Information</h1></div>
      ...
      <th scope="col">Contact Number</th>
       ...
       <th scope="col" class="text-center">Action</th>
                    ...
                    <tr>
                        ...
                        <td><a href="update.jsp?info_id=<%=resultSet.getString("info_id")%>">Update</a>
                        <a href="delete.jsp?info_id=<%=resultSet.getString("info_id")%>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
