<%-- 
    Document   : agentHome
    Created on : Mar 10, 2020, 10:58:50 PM
    Author     : PAVI
--%>
        ...
        <nav class="navbar navbar-expand-sm navbar-light fixed-top">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewContainer.jsp">Manage Containers</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="viewAgent.jsp">Transport Agent</a>
                    </li>
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                       	<a class="nav-link" href="loginOut.jsp">logout</a>
                    </li>
